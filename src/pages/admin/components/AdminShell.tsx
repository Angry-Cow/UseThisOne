...
export default function AdminShell({ children }: Props) {
  ...
  useEffect(() => {
    // Check current session — use the auth email directly, no Admin table lookup needed
    ...
    // Also listen for auth state changes (e.g. token refresh, sign-out)
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-white font-bold leading-tight text-sm sm:text-base">
              T.O.L.R.<sup className="text-xs">™</sup> Admin
            </h1>
            ...
            {NAV_ITEMS.map((item) => {
              ...
              return (
                <li key={item.path}>
                  <Link
                    to={item.path}
                    className={`flex items-center gap-3 px-2 sm:px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-150 group ${
                      active
